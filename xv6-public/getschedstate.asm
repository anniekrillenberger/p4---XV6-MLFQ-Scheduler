...
int main(int argc, char *argv[]) {
   ...
   b:	89 e5                	mov    %esp,%ebp
   d:	51                   	push   %ecx
   e:	81 ec 04 05 00 00    	sub    $0x504,%esp
    struct pschedinfo pi;

    printf(1, "getschedstate: %d\n", getschedstate(&pi));
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	8d 85 f8 fa ff ff    	lea    -0x508(%ebp),%eax
  1d:	50                   	push   %eax
  1e:	e8 22 03 00 00       	call   345 <getschedstate>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	0f b6 91 40 0a 00 00 	movzbl 0xa40(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 4f9:	75 25                	jne    520 <printf+0xff>
          s = "(null)";
 4fb:	c7 45 f4 eb 07 00 00 	movl   $0x7eb,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c2:	a1 5c 0a 00 00       	mov    0xa5c,%eax
...
morecore(uint nu)
{
 ...
 6eb:	83 c4 10             	add    $0x10,%esp
  return freep;
 6ee:	a1 5c 0a 00 00       	mov    0xa5c,%eax
}
 6f3:	c9                   	leave  
 6f4:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 707:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 70a:	a1 5c 0a 00 00       	mov    0xa5c,%eax
 70f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 712:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 716:	75 23                	jne    73b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 718:	c7 45 f0 54 0a 00 00 	movl   $0xa54,-0x10(%ebp)
 71f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 722:	a3 5c 0a 00 00       	mov    %eax,0xa5c
 727:	a1 5c 0a 00 00       	mov    0xa5c,%eax
 72c:	a3 54 0a 00 00       	mov    %eax,0xa54
    base.s.size = 0;
 731:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 738:	00 00 00 
  }
 ...
 78e:	a3 5c 0a 00 00       	mov    %eax,0xa5c
      return (void*)(p + 1);
 ...
 799:	eb 3b                	jmp    7d6 <malloc+0xe1>
    ...
    if(p == freep)
 79b:	a1 5c 0a 00 00       	mov    0xa5c,%eax
